...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    private void HandleInitCompleteAction(InitializationStatus initstatus)
    {
        ...
        MobileAdsEventExecutor.ExecuteInUpdate(() =>
        {
            ...
            if(DataManager.Instance.isAdsRemoved == false)
            {
                //RequestBannerAd();
            }
    ...
    private AdRequest CreateAdRequest(string ad)
    {
    ...
    public void RequestBannerAd()
    {
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7945457524558806/5101361820";
#endif
        ...
        // Load a banner ad
        bannerView.LoadAd(CreateAdRequest("GundayBanner"));
    }
...
#region INTERSTITIAL ADS
    ...
    {
        if (DataManager.Instance.isAdsRemoved)
            return;
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7945457524558806/3147499361";
#endif
        ...
        interstitialAd.LoadAd(CreateAdRequest("GundayGecis"));
    }
...
#region REWARDED ADS
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7945457524558806/2069656761";
#endif
        ...
        rewardedAd.LoadAd(CreateAdRequest("GundayReviveRewarded"));
    }
